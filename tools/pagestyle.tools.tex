...
\cs_new:Npn \__easytools_define_pagestyle:nn #1 #2 {
    ...
    }
    {
        ...
        \exp_args:Ncx\tl_gset:cn {ps@#1} {
            \__easytools_set_pagestyle_for_head:
            \__easytools_set_pagestyle_for_foot:
        }
        % \tl_show:c {ps@#1}
        \group_end:
    }
...
\NewDocumentCommand{\set}{}{\__easytools_define_pagestyle:nn}
...
\keys_define:nn {easytools/pagestyle} {
    ...
    twoside.code:n = {
        ...
        \use:c {@twoside#1} \use:c{@mparswitch#1}
    },
    ...
    \bool_if:NTF \l__easytools_pagestyle_twoside_bool 
    {
        ...
        }
        {
            \exp_args:NNx \tl_set:Nn \@oddhead {
                \tl_use:N \l__easytools_pagestyle_odd_head_left_tl \hfill 
                \tl_use:N \l__easytools_pagestyle_odd_head_center_tl \hfill 
                \tl_use:N \l__easytools_pagestyle_odd_head_right_tl 
            }
            \exp_args:NNx \tl_set:Nn \@evenhead {
                \tl_use:N \l__easytools_pagestyle_even_head_left_tl \hfill 
                \tl_use:N \l__easytools_pagestyle_even_head_center_tl \hfill 
                \tl_use:N \l__easytools_pagestyle_even_head_right_tl 
            }
        }
        {
    ...
    \bool_if:NTF \l__easytools_pagestyle_twoside_bool 
    {
        ...
        }
        {
            \exp_args:NNx \tl_set:Nn \@oddfoot {
                \tl_use:N \l__easytools_pagestyle_odd_foot_left_tl \hfill 
                \tl_use:N \l__easytools_pagestyle_odd_foot_center_tl \hfill 
                \tl_use:N \l__easytools_pagestyle_odd_foot_right_tl 
            }
            \exp_args:NNx \tl_set:Nn \@evenfoot {
                \tl_use:N \l__easytools_pagestyle_even_foot_left_tl \hfill 
                \tl_use:N \l__easytools_pagestyle_even_foot_center_tl \hfill 
                \tl_use:N \l__easytools_pagestyle_even_foot_right_tl 
            }
        }
        {
